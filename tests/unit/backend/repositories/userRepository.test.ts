...
class UserRepository extends BaseRepository<User> {
  ...
  async updateProfile(usuarioId: string, profileData: Partial<User>): Promise<User | null> {
    return this.update(usuarioId, profileData);
  }

  async deactivateUser(usuarioId: string): Promise<User | null> {
    return this.update(usuarioId, { ativo: false });
  }

  async activateUser(usuarioId: string): Promise<User | null> {
    return this.update(usuarioId, { ativo: true });
  }
...
describe('UserRepository', () => {
  ...
  describe('updateProfile', () => {
    it('should update user profile successfully', async () => {
      ...
      // Act
      const result = await repository.updateProfile(usuarioId, profileData);
      
      // Assert
      expect(mockSupabase.from).toHaveBeenCalledWith('users');
      expect(mockSupabase._methods.update).toHaveBeenCalledWith(profileData);
      expect(mockSupabase._methods.eq).toHaveBeenCalledWith('id', usuarioId);
  ...
  describe('deactivateUser', () => {
    it('should deactivate a user successfully', async () => {
      ...
      // Act
      const result = await repository.deactivateUser(usuarioId);
  ...
  describe('activateUser', () => {
    it('should activate a user successfully', async () => {
      ...
      // Act
      const result = await repository.activateUser(usuarioId);
