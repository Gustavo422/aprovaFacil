...
export default function SimuladosClient({ simulados: initialSimulados, categorias: initialCategorias }: SimuladosClientProps) {
  const [simulados, setSimulados] = useState<Simulado[]>(initialSimulados);
  const [loading, setLoading] = useState(false);
  const [searchTerm, setSearchTerm] = useState('');
  const [selectedCategory, setSelectedCategory] = useState('todos');
  const [categorias, setCategorias] = useState<ConcursoCategoria[]>(initialCategorias);
