...
import { PlanoEstudosForm } from '@/app/dashboard/plano-estudos/plano-estudos-form';
...
export default function PlanoEstudosClient() {
  ...
  const handlePlanoCriado = (novoPlano: PlanoEstudo) => {
    setPlanoEstudo(novoPlano);
    setIsFormOpen(false);
  };
          ...
          <CardContent>
            <Dialog open={isFormOpen} onOpenChange={setIsFormOpen}>
              ...
              <DialogContent>
                ...
                <PlanoEstudosForm onPlanoCriado={handlePlanoCriado} />
              </DialogContent>
            </Dialog>
          </CardContent>
        </Card>
